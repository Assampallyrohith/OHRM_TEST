...
<a class="tabcopy" href="/oprs-web/home/aboutus.do" target="_top" title="About Us">About Us</a><!-- "SpecialHire".equals(curTab) ||  -->
<a class="tabcopy blinking" href="/oprs-web/services/packagetours.do" target="_top" title="Tourism">Tourism</a>
<a class="tabcopy" href="/oprs-web/services/driverInfo.do" target="_top" title="Driver Info">Driver Info</a><!-- <a class="tabcopy" href="https://forms.gle/BVVhmKJ8gnd7rWvr8" target="_blank" title="Customer Survey Form" style="float: right !important;">Customer Survey Form</a> -->
</div>
*/
By tsrtclinks=By.tagName("a");

System.out.println(tsrtclinks); 

List<WebElement> tsrtecdisplayhomepagelink= driver.findElements(tsrtclinks);


  int  tsrtcheaderrlinks= tsrtecdisplayhomepagelink.size();
  System.out.println(tsrtcheaderrlinks);

 
  
  for(int arrayIndex=0;arrayIndex<tsrtcheaderrlinks;arrayIndex++)
  {
  String tsrtcHomePage_LinkName=tsrtecdisplayhomepagelink.get(arrayIndex).getText();
